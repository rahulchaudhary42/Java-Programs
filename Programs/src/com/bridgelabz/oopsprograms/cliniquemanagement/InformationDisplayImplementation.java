...

	{
		try {
			...
			personlist = mapper.readValue(
					new File("/home/admin1/Desktop/JavaProgram/Programs/src/com/bridgelabz/oopsprograms/cliniquemanagement/Patients.json"),
					new TypeReference<List<Patients>>() {
					});
			doctorlist = mapper.readValue(
					new File("/home/admin1/Desktop/JavaProgram/Programs/src/com/bridgelabz/oopsprograms/cliniquemanagement/Doctors.json"),
					new TypeReference<List<Doctor>>() {
					});
			appointmentlist = mapper.readValue(new File(
					"/home/admin1/Desktop/JavaProgram/Programs/src/com/bridgelabz/oopsprograms/cliniquemanagement/Appointment.json"),
