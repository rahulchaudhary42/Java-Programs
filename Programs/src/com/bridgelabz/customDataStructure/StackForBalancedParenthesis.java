...
public class StackForBalancedParenthesis<T> 
{
	int capacity = 10;  // the variable used to init capacity of stack array
    Object[] stack = new Object[capacity]; // Array for storing values in stack with size same as capacity
	private int top = 0; // chech for index value of the object
	...
	public void push(T data) 
	{
		...
		if (top == capacity)   // checks for current papcity of array
		{
			expand();
		}
		// puts data in stack
